...
const openCategoryContextMenu = (event) => {
                ...
                <div className="asset-form-group">
                    ...
                    {categoryMode === "select" ? (
                        ...
                        <button
                            ...
                            if (category) saveEditedCustomCategory(category);
                            }}
                        >
                            Save
                        </button>
                    ...
                    {categoryMenu && (
                      ...
                      >
                        <button
                          type="button"
                          onClick={() => beginEditCustomCategory(categoryMenu.category)}
                        >
                          Edit
                        </button>
                        <button
                          type="button"
                          className="danger-action"
                          onClick={() => deleteCustomCategory(categoryMenu.category)}
                        >
                          Delete
                        </button>
                      </div>
